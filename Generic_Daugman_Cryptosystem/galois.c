...
/*
	This function appears to be initializing a Galois Table of size 256
	It is being duplicated due to its cyclic nature so that compuation can be handled in a more direct manner
	- Added by Charles McGuffey on 5/28/2014 in order to attempt to understand and document code functionality
*/
static void
init_exp_table (void)
{
